# Make sure to open this file with a bash (Git bash or Unix Bash, doesn't work on PowerShell or Windows CMD)
#!/bin/bash
UID = $(shell id -u)
DOCKER_BE = aaxistest-php81-symfony54
...
start: ## Start the containers
	docker network create aaxistest-php81-symfony54-network || true
